...
public class ManagementLogin extends JPanel implements ActionListener {
	...
	public void initTablePanel() {
		...
		label.setIcon(new ImageIcon("D:\\123\\design.jpg"));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == btnIn) {
			...
			try {
				PreparedStatement pstmt=conn.prepareStatement("update users set code='"+code+"', email='"+email+"',tele='"+tel+"',file='"+file+"' where id='"+id+"'");
				pstmt.executeUpdate();
				initTabelContent();
			} catch (SQLException e1) {
