...
public class RecordWindow extends JDialog implements ActionListener {
	...
	private JButton btnMe, btnRecords, btnWelcome, btnAdd, btnModify, btnDel, btnSave, btnShow, picButton;
	...
	private void initDialog() {
		...
		JLabel label2;
		label2 = new JLabel();
		label2.setIcon(new ImageIcon("D:\\123\\design.jpg"));
		JLabel label3;
		label3 = new JLabel();
		label3.setIcon(new ImageIcon("D:\\123\\design2.jpg"));
		JLabel infoLabel;
	...
	private void initMyPanel() {
		...
		label[15].setIcon(new ImageIcon("D:\\123\\label15.jpg"));
	...
	private void initTable() {
		...
		notes = new Notes(list, fileName);
		calculateTotal();
		btnAdd = new JButton("<html><center>记</center><br>一<br>笔</html>");
	...
	public void actionPerformed(ActionEvent e) {
		...
		/*	list = ControlDemo.noteUpd(list, table, picFile);
			...
			list = ControlDemo.noteUpd(list, table, picFile);
			notes = new Notes(list, table);
			ServerDemo server=new ServerDemo(fileName);
	...
	/* public static void main(String[] args) { new RecordWindow(new
	 JFrame(),"zys", "457920700@qq.com", "15576870646","D:\\123\\DataInputStream.txt"); }
*/
